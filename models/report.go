...
type Report struct {
	...
	// Ra measurements
	Mdc_idc_msmt_ra_impedance_mean int `json:"mdc_idc_msmt_ra_impedance_mean"`
	Mdc_idc_msmt_ra_sensing_mean   int `json:"mdc_idc_msmt_ra_sensing_mean"`
	Mdc_idc_msmt_ra_threshold      int `json:"mdc_idc_msmt_ra_threshold"`
	Mdc_idc_msmt_ra_pw             int `json:"mdc_idc_msmt_ra_pa"`
	// Rv measurements
	Mdc_idc_msmt_rv_impedance_mean int `json:"mdc_idc_msmt_rv_impedance_mean"`
	Mdc_idc_msmt_rv_sensing_mean   int `json:"mdc_idc_msmt_rv_sensing_mean"`
	Mdc_idc_msmt_rv_threshold      int `json:"mdc_idc_msmt_rv_threshold"`
	Mdc_idc_msmt_rv_pw             int `json:"mdc_idc_msmt_rv_pa"`
	// HV measurements
	Mdc_idc_msmt_shock_impedance int `json:"mdc_idc_msmt_shock_impedance"`
	// Lv measurements
	Mdc_idc_msmt_lv_impedance_mean int `json:"mdc_idc_msmt_lv_impedance_mean"`
	Mdc_idc_msmt_lv_threshold      int `json:"mdc_idc_msmt_lv_threshold"`
	Mdc_idc_msmt_lv_pw             int `json:"mdc_idc_msmt_lv_pa"`
